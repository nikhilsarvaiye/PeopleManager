...
module.exports = {
  link: [
    ...
    /** <link> tags for people web app icons **/
    { rel: 'icon', type: 'image/png', sizes: '256x256', href: '/assets/icons/people-icon-256x256.png' },

    /** <link> tags for favicons **/
    { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/assets/icons/people-icon-32x32.png' },
    { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icons/people-icon-96x96.png' },
    { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/assets/icons/people-icon-16x16.png' },
